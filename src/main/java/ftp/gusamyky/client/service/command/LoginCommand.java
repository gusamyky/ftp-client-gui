...
public class LoginCommand implements NetworkCommand<Boolean> {
    ...
    public LoginCommand(String username, String password, BufferedWriter writer, ServerMessageHandler messageHandler) {
